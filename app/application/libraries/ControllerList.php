...
class ControllerList {
     ...
     */
    private $aControllers,$descartar;
    ...
    function __construct() {
		...
		$this->descartar	=	array("","Welcome","Main","Autenticacion","Home","Bot","Apanel","ApiRest");
    ...
    public function setControllerMethods($p_sControllerName, $p_aControllerMethods) {
		if(!array_search($p_sControllerName,$this->descartar)){
